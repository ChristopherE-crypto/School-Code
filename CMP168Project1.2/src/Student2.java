...
public class Student2 extends Person{//Original student. works.
	...
	public Student2(boolean isGraduate) {
		super();
		coursesTaken = new Course[50];
		numCoursesTaken = 0;
	...
	public Student2(String major, boolean isGraduate) {
		super();
		coursesTaken = new Course[50];
		numCoursesTaken = 0;
		this.isGraduate = isGraduate;
	...
	public Student2(String name, int birthYear, String major, boolean isGraduate) {
	...
	public int compareTo(Person p) {
		...
		if(p instanceof Student2) {
			...
			for(int i = 0; i < ((Student2)p).getNumCoursesTaken(); i++) {
				totalCredits2 += ((Student2)p).getCourseTaken(i).getNumCredits();
			}
